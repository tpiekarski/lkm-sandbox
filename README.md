...
---|---|---
[permissions-by-pthread.c](pocs/io-port-permissions/permissions-by-pthread.c)|How are I/O Permissions granted when using pthread?|[Bug 205317 - iopl(2) - privilege level is set per-process or per-thread?](https://bugzilla.kernel.org/show_bug.cgi?id=205317)
